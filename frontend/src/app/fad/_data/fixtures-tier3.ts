...
export const LEADS: Lead[] = [
  ...
  { id: 'i4', name: 'Tamarin Heights · Plot 7 fit-out', source: 'Architect referral · Lehningen', contact: 'ana.beauclair@gmail.com', type: 'Interior · new-build full fit-out · TH-07', value: 'est. € 320,000 one-off', stage: 'qualifying', pipeline: 'interior', nextStep: 'Plot walkthrough scheduled May 12', owner: 'Ishant', age: '4d' },
  { id: 'i5', name: 'Camp de Masque · Couture Apt B-2', source: 'Past client · Sunset Retreats', contact: 'priya.couture@gmail.com', type: 'Interior · 2-bed apt restyle · CM-B2', value: 'est. € 55,000 one-off', stage: 'meeting', pipeline: 'interior', nextStep: 'Site visit · prefs intake Apr 30', owner: 'Ishant', age: '11d' },
  { id: 'i6', name: 'La Preneuse · Vasiliev villa refresh', source: 'Owner-initiated', contact: 'svetlana.v@protonmail.com', type: 'Interior · soft refresh · LP-04', value: 'est. € 68,000 one-off', stage: 'proposal', pipeline: 'interior', nextStep: 'Annex A signature pending', owner: 'Mary', age: '9d' },
  { id: 'i7', name: 'Black River Gorges · Esposito retreat', source: 'Direct inbound', contact: 'a.esposito@studio-italia.it', type: 'Interior · single-villa fit-out · BRG-01', value: 'est. € 175,000 one-off', stage: 'inquiry', pipeline: 'interior', nextStep: 'Discovery call · scope unclear', owner: 'Mary', age: '1d' },
  { id: 'i8', name: 'Belle Mare · Okonkwo penthouse', source: 'Estate agent · Pam Golding', contact: 'chidi.okonkwo@gmail.com', type: 'Interior · luxury penthouse · BM-PH3', value: 'est. € 420,000 one-off', stage: 'qualifying', pipeline: 'interior', nextStep: 'Budget alignment + tier confirm', owner: 'Ishant', age: '6d' },
  { id: 'i9', name: 'Trou aux Biches · Murakami refresh', source: 'Past guest', contact: 'kenji.m@gmail.com', type: 'Interior · partial refresh · TAB-15', value: 'est. € 32,000 one-off', stage: 'won', pipeline: 'interior', nextStep: 'Convert to project · Annex A drafted', owner: 'Mary', age: 'won 1d' },
  { id: 'i10', name: 'Pereybère · Schmidt villa', source: 'Friday-managed owner', contact: 'klaus.schmidt@web.de', type: 'Interior · full fit-out · PB-08', value: 'est. € 195,000 one-off', stage: 'lost', pipeline: 'interior', nextStep: 'Owner deferred to 2027', owner: 'Ishant', age: 'lost 21d' },
  // Agency pipeline
