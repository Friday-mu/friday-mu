...
export const PROPERTIES: Property[] = [
  ...
  // ── Multi-unit · Villa Azur Apartments (VA-1, VA-2, VA-3, VA-4 + VA-C combo) ──
  {
    id: 'p-va1', code: 'VA-1', name: 'Villa Azur Apt 1', buildingName: 'Villa Azur Apartments',
    address: 'Apt 1, Villa Azur Apartments, Bel Ombre',
    region: 'bel_ombre', area: 'Bel Ombre · South', zone: 'west', tier: 'medium',
    lifecycleStatus: 'live', onboardingChecklist: LIVE_COMPLETE(),
    listingType: 'apartment', bedrooms: 2, bathrooms: 1, maxOccupancy: 4,
    primaryOwnerId: 'o2', parentPropertyId: 'p-vac',
    listings: [{ channel: 'airbnb', externalId: 'air-va1-21', status: 'active' }, { channel: 'friday_mu', externalId: 'fr-va1', status: 'active' }],
    baseRateMUR: 9_500_00, photoIds: ['ph-va1-1'], tags: ['Family-friendly'],
    occupancyYTD: 0.67, occupancy90d: 0.7, adr: 220, rating: 4.57, ratingCount: 16, lastActivityAt: '2026-04-20',
  },
  {
  ...
  },
  {
    ...
    region: 'bel_ombre', area: 'Bel Ombre · South', zone: 'west', tier: 'small',
    lifecycleStatus: 'live', onboardingChecklist: LIVE_COMPLETE(),
    listingType: 'apartment', bedrooms: 1, bathrooms: 1, maxOccupancy: 2,
    primaryOwnerId: 'o2', parentPropertyId: 'p-vac',
  ...
  },
  {
    ...
    baseRateMUR: 8_500_00, photoIds: ['ph-va4-1'], tags: ['Couples'],
    occupancyYTD: 0.69, occupancy90d: 0.72, adr: 260, rating: 4.66, ratingCount: 21, lastActivityAt: '2026-04-22',
  },
  {
    id: 'p-vac', code: 'VA-C', name: 'Villa Azur Apartments Combo (1+2+3+4)', buildingName: 'Villa Azur Apartments',
    address: 'Villa Azur Apartments (full block), Bel Ombre',
    region: 'bel_ombre', area: 'Bel Ombre · South', zone: 'west', tier: 'big',
    lifecycleStatus: 'live', onboardingChecklist: LIVE_COMPLETE(),
    listingType: 'villa', bedrooms: 6, bathrooms: 4, maxOccupancy: 12,
    primaryOwnerId: 'o2', isCombo: true, componentPropertyIds: ['p-va1', 'p-va2', 'p-va3', 'p-va4'],
