...
| FAD Ops / Friday Consult | strong active plan | strong Ops KB | improving, still young | learning events + schedule constraints live; planner guardrails live; PR #59 merged to origin seeds draft context pack for `fad_ops_assistant` and mirrors global Ops turns into that surface | focused tests green; bounded live Ops prompt smoke passed; PR #21 Ops guardrail tests/build green; PR #25 deterministic fallback tests/build green; PR #33 pricing-cache proof tests/build green; live pricing-caveat smoke passed; 2026-05-29 staff-shaped API smoke passed for schedule, roster, and urgent occupied-property triage; PR #44 compact-first tests/build/live smoke green; PR #59 full backend tests green | live at `af513255`; PR #59 not deployed | daily schedule draft, broad schedule-review Consult smoke, and compact-first roster smoke passed; still needs Franny staff-use proof in browser | Plan 1 materially improved; API/model proof passed; staff-use proof still open |
