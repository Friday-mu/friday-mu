...
Current canonical checkpoint: `origin/fad-rebuild` at `28c7794cea388004a9ea16f821177bfe076144e8`; live production remains `af513255723d68b3354de351c381f89532366efe`.
...
|---|---|---|---|---|---|---|---|---|
| Ask Friday Core | built beyond scaffold | partial global contracts | worker/review/policy scaffold | runtime wired live; PR #59 merged to origin adds active runtime draft packs and mirrored learning feedback | focused tests green; live API smoke passed; PR #59 full backend tests green; current branch adds route-level global/module event test | live at `af513255`; origin has PR #59 plus docs/UI merges but PR #59 runtime delta is not deployed | not directly user-facing | deployed control plane, not finished platform |
| FAD Inbox / Friday Consult | mature existing plan | existing Inbox/runtime KB | strong existing harness | learning events + DB turn lease live; PR #59 merged to origin seeds draft context pack for `fad_consult` | focused tests green; live structured Consult smoke passed; detail load fix verified; PR #20 Consult draft/timer tests green; PR #27 review-only tests/build green; PR #30 handoff/WhatsApp/draft recovery tests green; PR #35 malformed-envelope tests/build/live smoke green; PR #37 WhatsApp-window schema tests/build/live detail smoke green; PR #39 compact-fallback tests/build/live compose smoke green | live at `af513255`; PR #59 not deployed | live staff-shaped API smoke passed for review-only and compose drafts; still needs Mary/Franny staff-use proof in browser | Plan 1 code deployed; continue staff-use proof |
| FAD Ops / Friday Consult | strong active plan | strong Ops KB | improving, still young | learning events + schedule constraints live; planner guardrails live; PR #59 merged to origin seeds draft context pack for `fad_ops_assistant` and mirrors global Ops turns into that surface; current branch adds deterministic lunch coverage signal | focused tests green; bounded live Ops prompt smoke passed; PR #21 Ops guardrail tests/build green; PR #25 deterministic fallback tests/build green; PR #33 pricing-cache proof tests/build green; live pricing-caveat smoke passed; 2026-05-29 staff-shaped API smoke passed for schedule, roster, and urgent occupied-property triage; PR #44 compact-first tests/build/live smoke green; PR #59 full backend tests green; current branch focused tests/build green | live at `af513255`; current branch not deployed | daily schedule draft, broad schedule-review Consult smoke, and compact-first roster smoke passed; still needs Franny staff-use proof in browser | Plan 1 materially improved; API/model proof passed; staff-use proof still open |
| FAD global Ask Friday | subplan added | module context only | existing FAB/action harness plus TeamInbox/page-focus contract | events + action mirroring live; TeamInbox context and right-panel focus envelope live; Core state/readiness loading live; PR #59 merged to origin adds draft context pack and module learning mirrors | focused tests green; live harmless-action smoke passed; PR #41 tests green; PR #42 page-focus contract tests/build green; post-deploy TeamInbox/page-focus API smoke passed; PR #59 full backend tests green | live at `af513255`; PR #59 not deployed | staff command smoke passed for navigation and page-focus context | Plan 1 mostly clear; frontend can evolve to unified right-panel shell without changing Core ownership |
...
| Reservations/calendar agent | source-mapped, not full agent | source matrix + KB shell drafted | read-tool/action-request contracts drafted; Core shell readiness live | staff-only read context route live; eval seeds live; KB shell and governed Core shell live; current branch fixes checkout-excluded overlap and caveats missing calendar coverage | focused tests green locally; live context-tool smoke passed; composer shell smoke passed in PR #48; PR #52 policy/eval/template tests green; current branch context-tool tests green | deployed at `af513255`; current branch not deployed | no dedicated agent UI yet | governed Core shell, not a full UI agent |
| Properties agent | source-mapped, not full agent | public/private split + KB shell drafted | read-tool contract drafted; Core shell readiness live | staff-only read context route live; eval seeds live; KB shell and governed Core shell live | focused tests green locally; live context-tool smoke passed; composer shell smoke passed in PR #48; PR #52 policy/eval/template tests green | deployed at `af513255` | no dedicated agent UI yet | staff shell governable; public field policy still needs Ishant review before public packs |
...
- 2026-05-29 live production reports `af513255` for both frontend and backend. At that deployment checkpoint, the previously undeployed Core shell and Website public action-scope work became live along with subsequent Ops/perf fixes. PR #57 added global Ask Friday Core state/readiness loading; PR #58 fixed global Ask Friday learning-event scope drift. Origin later advanced to `5c1e4b2a` with PR #59, but live remains `af513255` until the next coordinated deploy.
- 2026-05-29 PR #59 merged as `5c1e4b2a`; it adds migrations `109_ask_friday_learning_feedback_policies.sql`, `110_ask_friday_eval_readiness_coverage.sql`, and `111_ask_friday_active_runtime_context_pack_drafts.sql`; mirrors global Ask Friday page-aware learning events into active module surfaces; adds generated active runtime context-pack templates for global Ask Friday, Inbox Consult, and Ops Assistant; seeds non-destructive draft rows for those packs; and extends readiness with learning feedback policy/counts. It is not deployed; live remains `af513255`.
...
Continue Plan 1 browser/workflow usefulness verification on live `af513255`, especially real Mary/Franny Inbox and Ops use, then return to the broader Ask Friday agent/KB buildout.

As of 2026-05-29, PR #41 was merged into `origin/fad-rebuild` at `61960837` and adds staff-only TeamInbox context for global FAD Ask Friday. PR #42 was merged at `aa7e7f01` and adds the backend page-focus envelope for the shared right-panel Ask Friday design. Both changes are live in deploy `81025039` and remain included in live `af513255`.

PR #9 is no longer pending. It was merged as `da67c7be`, and production code now runs `af513255`, which includes PR #9, later Feedback FAB evidence-flow work, Website Ask Friday Core scopes, the Inbox/Consult structured-draft bugfix release, the WhatsApp-window Inbox detail fixes, Consult partial-output rejection, bounded Ops Consult compact fallback, the context-pack draft-script env fix, reviewed Website context-pack source tightening, the deterministic Ops Consult fallback, field-staff PWA work, PR #27 review-only Consult suppression, PR #30 Inbox/Consult/Feedback hardening, PR #31 right-panel direction docs, PR #41 TeamInbox context, PR #42 page-focus context, PR #44 compact-first Ops roster consults, PR #46 Plan 2 eval seeds, PR #52 Core shell readiness, PR #54 Website public action scope, PR #57 global Core state/readiness loading, and PR #58 learning-event scope repair. Production DB already has the two reviewed Website public context packs published. PR #59 is merged to origin but still not deployed.

Post-PR #59 planning anchors:
