...
| Owners agent | scoped | staff-private positioning + KB shell drafted | lead-capsule and positioning harness drafted; planned shell only | registry/eval seeds live; KB shell pending deploy; PR #52 adds owner KB alias but keeps surface planned | composer shell smoke passed in PR #48; PR #52 validates planned owner shell draft pack | eval seeds deployed; PR #48 KB shell and PR #52/107 alias update not deployed | no | later until owner-private rules locked |
