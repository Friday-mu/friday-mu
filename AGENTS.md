# AGENTS.md — Friday Admin Dashboard (FAD)
...
3. Visual sweep on dev server, **desktop + mobile** (375×812), all states — full UI checks per `~/.Codex/AGENTS.md` "UI verification"
...
- **Codex Operating Rules:** Notion `34d43ca88492810ea8aec815655e0042` — procedural rules + ADRs in force
...
Universal workflow rules (plan-first, verify-before-done, surface errors, minimal blast radius, escalation list) live in `~/.Codex/AGENTS.md` and the Universal Bootstrap Rules Notion page (`36443ca8849281fea06df5f83ae8e00a`). The below are Friday-specific only.
...
| Reviews | Ishant + Codex | May 2026 | v0.2 (`34f43ca8849281ec9a08eb46c3779831`). Phase 1 read-from-Reva. |
