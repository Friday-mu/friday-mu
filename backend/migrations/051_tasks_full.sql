...
-- richer status set (paused/reported/awaiting_approval), property +
-- reservation cross-links, source provenance, comments + cost lines.
--
...
ALTER TABLE tasks ADD CONSTRAINT tasks_status_check
  CHECK (status IN ('todo', 'in_progress', 'paused', 'reported', 'awaiting_approval', 'completed', 'cancelled'));
