...
--
-- Schema follows the Operations/Breezeway cutover brief:
--   id, tenant_id, project_id (nullable, design_projects FK), title,
--   description, status (legacy todo/in_progress/done/cancelled here,
--   normalised by 051_tasks_full.sql to the canonical Operations lifecycle),
